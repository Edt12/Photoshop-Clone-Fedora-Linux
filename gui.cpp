...
int main(int, char**)
{
...

    {
        ...
        // 2. Show a simple window that we create ourselves. We use a Begin/End pair to create a named window.
        {
            ...
            if(ImGui::Button("Download (Found in OutputFiles)")){
                
                stbi_write_png("OutputFiles/image.jpg",image_details.width,image_details.height,image_details.numColourChannels,image_details.image,image_details.width * image_details.numColourChannels);
            }
